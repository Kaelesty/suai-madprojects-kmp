...
import com.kaelesty.madprojects_kmp.blocs.memberProfile.MemberProfileContent
...
fun RootContent(
	...
	Children(
		...
		when (val instance = it.instance) {
			...
			is RootComponent.Child.MemberProfile -> MemberProfileContent(component = instance.component)
		}
	}
}