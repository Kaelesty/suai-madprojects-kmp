...
import com.kaelesty.madprojects.view.components.main.other_profile.OtherProfileContent
...
fun MainContent(
    ...
    Children(
        ...
        when (val instance = it.instance) {
            ...
            is MainComponent.Child.OtherProfile -> OtherProfileContent(instance.component)
        }
    }
}